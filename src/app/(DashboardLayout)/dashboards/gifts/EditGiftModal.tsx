...
const EditGiftModal: React.FC<Props> = ({ isOpen, onClose, gift, onGiftUpdated }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await editGift(gift.uuid, {
        name,
        value: Number(value),
      });
      ...
      if (response.status) {
        ...
        toast.error(response.message || "Failed to update gift");
      }
