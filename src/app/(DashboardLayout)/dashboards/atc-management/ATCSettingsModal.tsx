                                        ...
                                        <div className="flex flex-wrap items-center justify-between gap-6">
                                            ...
                                            <div className="flex-[4] min-w-[400px]">
                                                <h5 className="text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide mb-3">
                                                    {isLocked ? "Selected ATC Episode" : "Select your preferred ATC Episode"}
                                                </h5>
                                                    ...
                                                    {isLocked ? (
                                                        ...
                                                        <div className="w-full">
                                                            <Select
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    if (val) {
                                                                        ...
                                                                        setIsLocked(true);
                                                                        console.log("Saving settings:", { period, status: val });
                                                                    }
                                                                }}
                                                            ...
                                                            >
                                                                ...
                                                                <option value="spotlight">Spotlight Africa</option>
                                                            </Select>
                                                        </div>
                                                    )}
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <ul className="space-y-4">
                                                <li className="flex items-start gap-3">
                                                    <Icon icon="solar:notes-bold-duotone" className="text-gray-400 mt-1" width={20} />
                                                    <span className="text-sm text-gray-600 dark:text-gray-400">Application is Free.</span>
                                                </li>
                                                <li className="flex items-start gap-3">
                                                    <Icon icon="solar:videocamera-record-bold-duotone" className="text-gray-400 mt-1" width={20} />
                                                    <span className="text-sm text-gray-600 dark:text-gray-400">
                                                        Uploading a 15-60 seconds video showcasing your talent will be required of you, as part of your application process.
                                                    </span>
                                                </li>
                                                <li className="flex items-start gap-3">
                                                    <Icon icon="solar:bell-bing-bold-duotone" className="text-gray-400 mt-1" width={20} />
                                                    <span className="text-sm text-gray-600 dark:text-gray-400">
                                                        If selected, you'll be notified by email or in-app notification.
                                                    </span>
                                                </li>
                                                <li className="flex items-start gap-3">
                                                    <Icon icon="solar:videocamera-bold-duotone" className="text-gray-400 mt-1" width={20} />
                                                    <span className="text-sm text-gray-600 dark:text-gray-400">
                                                        The winner will be announced on VillageSquare Live (Every 28 of each month by 8:00 PM)
                                                    </span>
                                                </li>
                                                <li className="flex items-start gap-3">
                                                    <Icon icon="solar:calendar-bold-duotone" className="text-gray-400 mt-1" width={20} />
                                                    <span className="text-sm text-gray-600 dark:text-gray-400">Candidates can only apply once in 6 months.</span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul className="space-y-4">
                                                {[
                                                    ...
                                                    <li key={i} className="flex items-start gap-3">
                                                        <Icon icon="solar:check-circle-bold" className="text-primary mt-1" width={18} />
