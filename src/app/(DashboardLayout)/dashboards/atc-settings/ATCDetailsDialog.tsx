                    ...
                    <div className="overflow-y-auto p-6 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 space-y-1">
                          ...
                          <p className="font-medium break-all">{application.occupation_duration || "N/A"}</p>
                        </div>
                        <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 space-y-1">
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            Date Joined
                      ...
                      {application.about && (
                        <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 space-y-2">
                          ...
                          <p className="text-sm leading-relaxed">{application.about}</p>
                        </div>
                      )}
                  ...
                  >
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          <h3 className="font-semibold text-lg dark:text-white">{application.fullname}</h3>
                          <p className="text-sm text-gray-500 dark:text-gray-400">@{application.user?.username || "N/A"}</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/50">
                          ...
                          <p className="text-2xl font-bold text-gray-900 dark:text-white">{application.votes_count || 0}</p>
                        </div>
                        <div className="p-4 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-900/50">
                          ...
                          <p className="text-2xl font-bold text-gray-900 dark:text-white">{application.likes_count || 0}</p>
                        </div>
                        <div className="p-4 rounded-xl bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-900/50">
                          ...
                          <p className="text-2xl font-bold text-gray-900 dark:text-white">{application.gifts_count || 0}</p>
                        </div>
                        <div className="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-900/50">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Comments</span>
                          </div>
                          <p className="text-2xl font-bold text-gray-900 dark:text-white">{application.comments_count || 0}</p>
                        </div>
                      </div>
